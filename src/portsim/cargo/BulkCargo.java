...
public class BulkCargo extends Cargo {
     ...
     * <p>
     * For two BulkCargo to be equal, they must have the same ID, destination, type and
     * tonnage.
     *
    ...
    public boolean equals(Object o) {
        if (o instanceof BulkCargo) {
            ...
            return super.equals(o) && type.equals(other.type) && tonnage == other.tonnage;
        }
        return false;
    }

    /**
     * Returns the hash code of this BulkCargo. Two BulkCargo are equal according to
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), type, tonnage);
    }

    /**
     * Returns the machine-readable string representation of this BulkCargo. The format of the
     * string to return is "BulkCargo:id:destination:type:tonnage" Where: id is the id of this
     * cargo destination is the destination of this cargo type is the bulk cargo type tonnage
     * is the bulk cargo weight in tonnes For example: "BulkCargo:2:Germany:GRAIN:50"
     *
